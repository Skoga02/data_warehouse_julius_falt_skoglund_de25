...
GRANT ROLE movies_reader TO USER SKOGLUND02;
GRANT MONITOR ON DATABASE movies TO ROLE movies_reader;
GRANT MONITOR ON SCHEMA movies.staging TO ROLE movies_reader;